...
def test_stage2_admin_handler_alias_langchain(monkeypatch) -> None:
    monkeypatch.setenv("STAGE2_ADMIN_HANDLER", "agent")
    cfg = get_config()
    assert cfg.STAGE2_ADMIN_HANDLER == "langchain_tools"
