...
This Terraform stack deploys the Stage 4 unified orchestration API as a Docker container.

## What is provisioned

- Docker image reference for project runtime (`parking-chatbot:latest` by default)
- Docker container running `uvicorn app.stage4.service:app` on port `9292`
- Runtime env for Stage 4 to call Stage 3 MCP service
...
- This stack is Stage 4 only; do not place Stage 1/2/3 infrastructure here.
